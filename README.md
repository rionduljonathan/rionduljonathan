...
- **Environmental Engineering @UBC.** Focused on building management systems, data analysis, and UI/UX design for all stakeholders.
- Prev. Product Strategy Intern @[Riipen](https://www.riipen.com/). HTML Website design, grant research, and media expansion for startup companies.

---

- **Engram** founder; a semantic AI memory layer connecting workspace apps, making company data searchable with Google OAuth. Deployed as a B2B SaaS
  on Vercel and made finals @**TechTO x Althra 2026 Hackathon**.
- Co-Lead for Marketing & Software @**UBC Sustaingineering Design Team**. Integrating Python data-monitoring software into our research testbeds (SMRTs)
  and optimizing media interfaces for stakeholder visibility.
- Marketing Head @**M.E.C.H**, a health awareness non-profit. Raised $3000 for hospital foundations and grew to 30+ members across BC and PEI through
